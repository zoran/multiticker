...
Sidekiq::Web.use Rack::Auth::Basic do |username, password|
  unless ENV['MULTITICKER_USERNAME'].to_s.strip.empty? && ENV['MULTITICKER_USERNAME'].to_s.strip.empty?
    username == ENV['MULTITICKER_USERNAME'] && password == ENV['MULTITICKER_PASSWORD']
  end
end
